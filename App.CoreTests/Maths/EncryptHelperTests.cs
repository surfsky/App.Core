...
namespace App.Core.Tests
{
    ...
    public class EncryptHelperTests
    {
        ...
        public void AESEncryptTest()
        {
            ...
            var msg = "Hello world";
            var encrypt = msg.AESEncrypt(key);        // "yIk4/SaPv97MxWt4QurYBw=="
            var decrypt = encrypt.AESDecrypt(key);
            Assert.AreEqual(msg, decrypt);
        }
        ...
        public void DesEncryptTest()
        {
            var key = "12345678";
            var msg = "Hello world";
            var encrypt = msg.DesEncrypt(key);       // "el5rMqH9gkJgQtrr+lloeg=="
        ...
        public void RSACreateKeyPairTest()
        {
            ...
            Assert.AreEqual(msg, decrytedMsg);
        }
        ...
        public void MD5Test()
        {
            ...
            var s3 = txt.SHA256();     // "C0535E4BE2B79FFD93291305436BF889314E4A3FAEC05ECFFCBB7DF31AD9E51A"
